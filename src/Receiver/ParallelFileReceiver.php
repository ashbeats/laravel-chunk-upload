...
use Pion\Laravel\ChunkUpload\Save\ParallelChunkSave;
...
class ParallelFileReceiver extends FileReceiver
{
     ...
     *
     * @var ParallelUploadHandler|AbstractHandler
     */
    ...
    public function receive()
    {
        ...
        if ($this->handler->isChunkedUpload()) {
            return new ParallelChunkSave($this->file, $this->handler, $this->chunkStorage, $this->config);
        } else {
